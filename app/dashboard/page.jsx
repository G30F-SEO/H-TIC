        ...
        <div className="fade-in">
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '28px' }}>
            <div>
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: '13px' }}>
                Lancez un contenu directement vers Make. Pour un workflow complet avec base de redaction, utilisez les <a href="/campaigns" style={{ color: 'var(--accent)', textDecoration: 'none' }}>Campagnes</a>.
              </p>
            </div>
          </div>
          ...
          >
            {loading ? (
              ...
              <><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg> Lancer vers Make</>
            )}
          </button>
        </div>
      </main>
